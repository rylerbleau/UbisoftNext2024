...
#define APP_VIRTUAL_WIDTH		(920)					// This will be the effective x resolution regardless of actual screen/window res.
#define APP_VIRTUAL_HEIGHT		(920)					// This will be the effective y resolution regardless of actual screen/window res.
