...
std::map<const char*, SpriteComponent::sTextureDef > SpriteComponent::m_textures;

//-----------------------------------------------------------------------------
SpriteComponent::SpriteComponent(Component* parent_, const char* fileName, unsigned int nColumns, unsigned int nRows)
    : Component(parent),
    m_nColumns(nColumns)
    , m_nRows(nRows)
{
...
void SpriteComponent::CalculateUVs()
{
...
void SpriteComponent::SetFrame(unsigned int f)
{
    m_frame = f;
...
bool SpriteComponent::LoadTexture(const char* filename)
{
